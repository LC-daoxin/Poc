...
const constantRouterComponents = {
  ...
  Report: () => import('@/views/dashboard/Report'),
  ...
  Proposal2: () => import('@/views/masterdata/Proposal2'),
  ...
  UploadFile: () => import('@/views/masterdata/UploadFile'),

  
  MyTask: () => import('@/views/masterdata/MyTask'),
