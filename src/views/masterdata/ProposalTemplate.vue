...
export default {
  ...
  methods: {
      ...
      this.$XModal
        ...
        .then(type => {
          if (type === 'confirm') {
            ...
            axios
              .post('http://47.103.127.217:8080/api/BaseData/ProposalTemplateDelete?templateID=' + checked.ID)
              .then(res => {
        ...
        .then(type => {
          if (type === 'confirm') {
            ...
            if (this.formData.ID == null) {
              axios
                .post('http://47.103.127.217:8080/api/BaseData/ProposalTemplateCreate', [this.formData])
                .then(res => {
                  this.$XModal.close('loding')
                  if (res.data.Code == 200) {
              ...
              axios
                .post('http://47.103.127.217:8080/api/BaseData/ProposalTemplateUpdate', [this.formData])
                .then(res => {
                  this.$XModal.close('loding')
                  if (res.data.Code == 200) {
    ...
    getList(name) {
      axios
        .post('http://47.103.127.217:8080/api/BaseData/GetProposalTemplate?departmentID=&userName=' + name)
        .then(res => {
