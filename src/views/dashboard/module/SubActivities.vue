      ...
      tableParams: {
        ...
        columns: [
          ...
          },
          {
            ...
            ellipsis: true,
            customRender: (text, row, index) => (
              <a-input v-model:value={text} onChange={(e) => this.onChangePassPrice(e, row)} style="margin: -5px 0"  value={text}/>
            ),
          },
          {
            title: 'Duration',
            ...
            ellipsis: true,
            customRender: (text, row, index) => (
              <a-input v-model:value={text} onChange={(e) => this.onChangeDuration(e, row)} style="margin: -5px 0"  value={text}/>
            ),
          },
          {
            title: 'DisCount',
            ...
            ellipsis: true,
            customRender: (text, row, index) => (
              <a-input v-model:value={text} onChange={(e) => this.onChangeDisCount(e, row)} style="margin: -5px 0"  value={text}/>
            ),
          },
          {
            title: 'Scale',
            ...
            ellipsis: true,
            customRender: (text, row, index) => (
              <a-input v-model:value={text} onChange={(e) => this.onChangeScale(e, row)} style="margin: -5px 0" value={text} />
            ),
          },
        ],
      },
